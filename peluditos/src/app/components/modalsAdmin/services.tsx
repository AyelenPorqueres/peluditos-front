...
export const AddServices: React.FC<servicesProps> = ({ show, handleClose, data, action, updateData }) => {
    ...
    const onSubmit: SubmitHandler<data> = async (newData) => {
        ...
        //AGREGAR SERVICIO
        if (action == 'Agregar') {
            const resp = 201//await createService(service);
        ...
        //MOFICICAR SERVICIO
            ...
            //Si se modificaron datos se llama al backend para actualizarlos
                ...
                setErrorRegister('');
                const resp = 200//await updateService(service);
    ...
    const loadSpecialties = async () => {
        const resp = [{ id: '1', speciality: 'Cardiología' }, { id: '2', speciality: 'Dermatología' }, { id: '3', speciality: 'Pediatría' }]//await getSpecialtiesWhitProf();
        setSpecialties(resp);
    }
