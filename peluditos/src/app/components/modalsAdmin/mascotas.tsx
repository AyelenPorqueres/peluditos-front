...
import { updateMascota } from '@/app/services/client';
...
export const ModalMascota: React.FC<clientProps> = ({ show, handleClose, data, action, updateData }) => {
                    ...
                    <div className='row mb-2'>
                        <div className="col">
                            ...
                            <input
                                ...
                                defaultValue={data?.duenio.nombre}
                    ...
                    <div className='row mb-2'>
                        <div className="col">
                            ...
                            <input
                                type="text"
                                readOnly={action === 'Ver' || action === 'Modificar'}
                                defaultValue={data?.duenio.telefono}
